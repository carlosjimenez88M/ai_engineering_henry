...
def batman_comics_data():
    ...
    data_path = os.path.join(os.path.dirname(__file__), "..", "00_data", "batman_comics.json")
...
def eval_questions():
    ...
    data_path = os.path.join(os.path.dirname(__file__), "..", "00_data", "comics_eval.jsonl")
    questions = []
    if os.path.exists(data_path):
        with open(data_path) as f:
            for line in f:
