"""
Tests del router de tareas (todos) con dependency_overrides (Docker).

Prueba el CRUD completo de todos usando una base de datos SQLite
en memoria y usuarios simulados mediante override de dependencias.
