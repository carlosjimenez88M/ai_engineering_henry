"""
Fixtures compartidos para los tests de la TodoApp (Docker).

Usa imports absolutos con PYTHONPATH=/src (Docker) o PYTHONPATH=. (local),
...
from tests.utils import TestingSessionLocal, engine
