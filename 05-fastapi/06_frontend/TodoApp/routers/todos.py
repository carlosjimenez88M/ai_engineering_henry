"""
Router de tareas con páginas Jinja2 y endpoints REST.

Usa pathlib para templates portables. Incluye páginas de listado,
creación y edición de todos con redirección a login si no autenticado.
